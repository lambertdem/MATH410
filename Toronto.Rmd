...
```{r, warning=FALSE}
df <- read_csv("Datasets/TR_1937_2020.csv") #QC_1943_2020.csv
...
```{r}
ggplot(df_temperature_07, aes(x=Date_Time, y= Max_Temp)) + geom_point() + xlab("Date") + ylab("Max temperature") + ggtitle("Toronto Daily Maxima in July") + theme(plot.title = element_text(size=18, face="bold", 
