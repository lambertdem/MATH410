...
```{r}
city <- "Toronto" #Montreal Quebec Vancouver Toronto
csv <- "TR_1937_2020" #MTL_1941_2020 QC_1943_2020 VC_1937_2020 TR_1937_2020
originalColumn <- "Total Snow (cm)"
```


```{r, warning=FALSE}
df <- read_csv(paste("../Datasets/", csv, ".csv", sep = ""))
