...
```{r, warning=FALSE}
df <- read_csv("Datasets/VC_1937_2020.csv") #QC_1943_2020.csv
...
summary(mod_scale)
title <- paste0("Linearity of the scale parameter for u > ", u_0)
...
summary(mod_shape)
title <- paste0("Linearity of the shape parameter for u > ", u_0)
...
```{r}
mrlplot(obs, tlim = c(26,30), nt = 20,
